...
Computes the normalized Frobenius inner product between two symmetric
matrices, which measures the similarity between two kernels. Useful for
model selection and comparing different kernel parameterizations.
...
The kernel alignment is computed as: align(A,B) = \<A,B\>\_F /
(\|\|A\|\|\_F \* \|\|B\|\|\_F), where \<A,B\>\_F = sum(A \* B) is the
Frobenius inner product and \|\|A\|\|\_F is the Frobenius norm. This
provides a normalized measure of kernel similarity.
