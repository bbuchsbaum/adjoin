...
Calculate the weighted similarity matrix for a set of factors in a data
frame.
...
- des:
  ...
  A data frame containing factors for which the weighted similarity
  matrix will be computed.

- wts:

  A numeric vector of weights corresponding to the factors in the data
  frame. The default is equal weights for all factors.
