...
- Functions for constructing spatial and feature-weighted adjacency
  matrices.
- K-nearest neighbor graph construction with heat, binary, and cosine
  kernels.
- Class-based graph tools: `class_graph`, `homogeneous_neighbors`,
...
- Label similarity matrices (`binary_label_matrix`,
